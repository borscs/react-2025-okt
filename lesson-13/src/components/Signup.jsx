			...
			<fieldset>
				...
				<div className="control">
					<input
						...
						name="acquisition"
						value="google"
						defaultValue={formState.enteredValues?.acquisitionChannel.includes('google')}
					/>
				...
				<div className="control">
					<input
						...
						name="acquisition"
						value="friend"
						defaultValue={formState.enteredValues?.acquisitionChannel.includes('friend')}
					/>
				...
				<div className="control">
					<input type="checkbox" id="other" name="acquisition" value="other"
					       defaultValue={formState.enteredValues?.acquisitionChannel.includes('other')}/>
